...
class ATL_NO_VTABLE CPlisgoData :
	...
	public IDispatchImpl<IPlisgoData, &IID_IPlisgoData, &LIBID_PlisgoLib, /*wMajor =*/ 1, /*wMinor =*/ 0>,
	public IDataObject
{
public:
	CPlisgoData()
...
BEGIN_COM_MAP(CPlisgoData)
	COM_INTERFACE_ENTRY(IPlisgoData)
...
OBJECT_ENTRY_AUTO(__uuidof(PlisgoData), CPlisgoData)
